...
def grid_points(img, nPointsX, nPointsY, border):
    ...
    vPoints = np.zeros((nPointsX * nPointsY, 2), dtype=np.int)
...
def bow_recognition_nearest(histogram,vBoWPos,vBoWNeg):
    ...
    # Compute the Euclidean distances between the test image histogram and the histograms of positive and negative training images
