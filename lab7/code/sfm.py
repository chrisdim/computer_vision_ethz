...
def main():
  ...
  for pose in possible_relative_poses:
    ...
    # triangulate
    given_points, _, _ = TriangulatePoints(K, e_im1, e_im2, e_matches)

    # keep the pose that gives the most points
    if given_points.shape[0] > max_points:
      max_points = given_points.shape[0]
      best_pose = pose
